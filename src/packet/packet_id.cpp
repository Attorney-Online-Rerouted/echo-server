...
{
  PacketInfo info{.acl_permission = ACLRole::Permission::NONE, .min_args = 2, .header = "ID"};
  return info;
}
...
void PacketID::handlePacket(AreaData *area, AOClient &client) const
{
  ...
  QStringList l_feature_list = {"noencryption", "yellowtext", "prezoom", "flipping", "customobjections", "fastloading", "deskmod", "evidence", "cccc_ic_support", "arup", "casing_alerts", "modcall_reason", "looping_sfx", "additive", "effects", "y_offset", "expanded_desk_mods", "auth_packet"};
