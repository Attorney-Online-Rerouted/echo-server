...
void AOClient::loginAttempt(QString message)
{
  ...
  case DataTypes::AuthType::SIMPLE:
    ...
    emit logLogin((m_current_char + " " + m_showname), m_ooc_name, "Moderator", m_ipid, server->getAreaById(m_current_area)->name(), m_authenticated);
    break;
  case DataTypes::AuthType::ADVANCED:
    ...
    emit logLogin((m_current_char + " " + m_showname), m_ooc_name, username, m_ipid, server->getAreaById(m_current_area)->name(), m_authenticated);
    break;
  }
  sendServerMessage("Exiting login prompt.");
  m_is_logging_in = false;
