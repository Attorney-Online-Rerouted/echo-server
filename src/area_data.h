 ...
 */
class ECHO_SERVER_EXPORT AreaData : public QObject
{
  Q_OBJECT
...
signals:
   ...
   */
  void sendAreaPacket(ServerAOPacket *f_packet, int f_area_index);
   ...
   */
  void sendAreaPacketClient(ServerAOPacket *f_packet, int f_user_id);
